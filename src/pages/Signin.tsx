      ...
      <div className="col grid auto-rows-auto">
        ...
        <div className="px-6 w-[220px]">
          <h1 className="text-2xl font-semibold">
            Gerenciar <span className="text-primary">notas fiscais</span> nunca foi tão{' '}
            <span className="text-primary">fácil_</span>
          </h1>
        </div>
      </div>
      <div className="col flex items-end w-11/12">
        <img src={logoWoman} alt="logo-woman" style={{ maxHeight: 'calc(100vh - 10px)' }} />
      </div>
    </div>
  );
}
