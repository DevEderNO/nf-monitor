    ...
    () => [
      {
        ...
        selected: location.pathname === '/upload-invoices',
        onClick: () => {
      ...
      },
      {
        ...
        selected: location.pathname === '/upload-certificates',
        onClick: () => {
          navigate('/upload-certificates', {
            replace: true,
            state: { from: location },
          });
        },
      ...
      {
        label: 'Download de Notas SIEG',
        selected: location.pathname === '/download-invoices-sieg',
        onClick: () => {
          navigate('/download-invoices-sieg', {
            replace: true,
            state: { from: location },
          });
        },
